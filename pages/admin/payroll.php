...
<head>
  ...
  <style>
    ...
    .form-box { background: #fff; border: 1px solid #ddd; border-radius: 6px; padding: 16px; margin-bottom: 20px; display: flex; gap: 12px; align-items: flex-end; flex-wrap: wrap; }
    label { display: block; font-size: 13px; margin-bottom: 3px; }
    input[type="date"] { padding: 7px; border: 1px solid #ccc; border-radius: 4px; font-size: 13px; }
    input[type="submit"] { padding: 8px 16px; background: #065A82; color: #fff; border: none; border-radius: 4px; cursor: pointer; font-size: 13px; }
    ...
    .total-row td { font-weight: bold; background: #e8f1fb; }
  </style>
</head>
<body>
